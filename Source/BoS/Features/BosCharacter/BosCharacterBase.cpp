...
#include "Movement/BosMovementComponent.h"


// Sets default values
ABosCharacterBase::ABosCharacterBase(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UBosMovementComponent>(ACharacter::CharacterMovementComponentName))
{
